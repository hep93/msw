...
export interface RestRequest<BodyType extends DefaultRequestBody = DefaultRequestBody, ParamsType extends RequestParams = PathParams> extends MockedRequest<BodyType> {
    params: ParamsType;
}
